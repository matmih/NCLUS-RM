 ...
 * @author matej
 */
public class ExperimentationNoNetwork {
     public static void main(String[] args) {
        ...
        System.out.println("Attribute importance: "+appset.attributeImportance);
         ...
         DataSetCreator datJT=new DataSetCreator(appset.viewInputPaths, appset.outFolderPath,appset);
        ...
        appset.Bandwith = 100;
         if(appset.distanceFilePaths.size()==0 && appset.useNetworkAsBackground==true || appset.computeDensity == true){
            ...
            nclMatInit.numElem = datJT.numExamples;
          //  int test = 1;
           ...
           /* if(test == 1){
                nclMatInit.loadGlobalInfo(appset);
            }*/
         ...
         String initFileName = appset.initClusteringFileName;
        int g = 1;
        for(int joj = 0; joj<=g;joj++){
                if(joj == 0)
                    appset.useJoin = true;
                else appset.useJoin = false; 
                String plotOutput = "";
     for(int init = 1;init<=10;init++){ 
        ...
        ArrayList<Double> redScores=new ArrayList<>(appset.numInitial);
        ArrayList<Double> redScoresAtt=new ArrayList<>(appset.numInitial);
        ArrayList<Double> redDistCoverage=new ArrayList<>(appset.numInitial);
        ArrayList<Double> redDistCoverageAt=new ArrayList<>(appset.numInitial);
        ArrayList<Double> redDistNetwork=new ArrayList<>(appset.numInitial);
        ...
        ArrayList<Double> maxDiffScoreDistribution=new ArrayList<>(appset.numInitial);
        ...
        if(appset.initClusteringFileName.equals(""))
            ...
            appset.initClusteringFileName = initFileName+init+"1"+".arff";
   ...
   */
        ...
        dsc1.readDataset();
          ...
          if(leftSide==1 && (endIndexRR1-oldIndexRR1)>z*appset.numTargets){
             ...
             if(appset.numSupplementTrees>0){
                setF=new SettingsReader(appset.outFolderPath+"\\view2tmpF.s"/*"C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\wbtmp.s"*/,appset.outFolderPath+"\\view2.s"/*"C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\wbtmpS.s"*/);
                setF.setDataFilePath(appset.outFolderPath+"\\Jinputnew.arff"/*"C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\UNCTADall3testnew.arff"*/);
             }
             /*if(z!=0)
                 set.changeSeed();*/
             ...
             if(appset.numSupplementTrees>0){
                 if(datJ.W2indexs.size()>1)
                    setF.ModifySettingsF(nARules,dsc.schema.getNbAttributes(),datJ.W2indexs.get(0)+1, datJ.W2indexs.get(1),appset);

                 else    
                    setF.ModifySettingsF(nARules,dsc.schema.getNbAttributes(),datJ.W2indexs.get(0)+1, datJ.schema.getNbAttributes()+1,appset);
             }
       //modify settings
            /* for(int i=oldIndexRR1;i<endIndexRR1;i++) //do on the fly when reading rules
             ...
             System.out.println("Breakpoint!");
                 ...
                 set.setDataFilePath(appset.outFolderPath+"\\Jinputnew.arff"/*"C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\UNCTADall3testnew.arff"*/);
                 if(appset.numSupplementTrees>0){
                    setF=new SettingsReader(appset.outFolderPath+"\\view1tmpF.s"/*"C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\unctadtmp.s"*/,appset.outFolderPath+"\\view1.s"/*"C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\unctadtmpS.s"*/);
                    setF.setDataFilePath(appset.outFolderPath+"\\Jinputnew.arff"/*"C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\UNCTADall3testnew.arff"*/);
                 }
                 /* if(z!=0)
                     set.changeSeed();*/
             ...
             int startIndexRR=oldIndexRR+z*appset.numTargets;
                ...
                if(appset.numSupplementTrees>0)
                    setF.ModifySettingsF(nARules,dsc1.schema.getNbAttributes(),3, datJ.W2indexs.get(0),appset);
        ...
        if(leftSide1==1 && (endIndexRR1-oldIndexRR1)>z*appset.numTargets){
            ...
            if(appset.numSupplementTrees>0){
                setF1=new SettingsReader(appset.outFolderPath+"\\view2tmpF1.s"/*"C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\wbtmpS1.s"*/,appset.outFolderPath+"\\view2.s"/*"C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\wbtmpS.s"*/);
                setF1.setDataFilePath(appset.outFolderPath+"\\Jinputnew1.arff"/*"C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\UNCTADall3testnew1.arff"*/);
            }
             /* if(z!=0)
                 set1.changeSeed();*/
             ...
             if(appset.numSupplementTrees>0)
                 if(datJ.W2indexs.size()>1)
                    setF1.ModifySettingsF(nARules1,dsc.schema.getNbAttributes(),datJ.W2indexs.get(0)+1, datJ.W2indexs.get(1),appset);
                 else    
                    setF1.ModifySettingsF(nARules1,dsc.schema.getNbAttributes(),datJ.W2indexs.get(0)+1, datJ.schema.getNbAttributes()+1,appset);
                //setF1.ModifySettingsF(nARules1,dsc.schema.getNbAttributes(),datJ.W2indexs.get(0)+1, datJ.W2indexs.get(1),appset);
            ...
            /* for(int i=oldIndexRR1;i<endIndexRR1;i++)
             ...
             System.out.println("Breakpoint!");
              ...
              set1.setDataFilePath(appset.outFolderPath+"\\Jinputnew1.arff"/*"C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\UNCTADall3testnew1.arff"*/);
              if(appset.numSupplementTrees>0){
                setF1=new SettingsReader(appset.outFolderPath+"\\view1tmpF1.s"/*"C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\unctadtmpS1.s"*/,appset.outFolderPath+"\\view1.s"/*"C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\unctadtmpS.s"*/);
                setF1.setDataFilePath(appset.outFolderPath+"\\Jinputnew1.arff"/*"C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\UNCTADall3testnew1.arff"*/);
              }
              /*if(z!=0)
                    set1.changeSeed();*/
             ...
             int startIndexRR=oldIndexRR+z*appset.numTargets;
              ...
              if(appset.numSupplementTrees>0)
                    setF1.ModifySettingsF(nARules1,dsc1.schema.getNbAttributes(),3, datJ.W2indexs.get(0),appset);
       ...
       //extract rules for cicle 1
        ...
        if(leftSide==1 && (endIndexRR1-oldIndexRR1)>z*appset.numTargets){
         ...
         inputF=appset.outFolderPath+"\\view2tmpF.out"/*"C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\wbtmp.out"*/;
        }
        else if(rightSide==1 && (endIndexRR-oldIndexRR)>z*appset.numTargets){
            input=appset.outFolderPath+"\\view1tmp.out"/*"C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\unctadtmp.out"*/;
            if(appset.numSupplementTrees>0) 
                inputF=appset.outFolderPath+"\\view1tmpF.out"/*"C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\unctadtmp.out"*/;
        }
        //String input1="C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\unctad.out";
       int newRules=0;
       ...
       // rr.extractRules(input);
        ...
        if(leftSide1==1 && (endIndexRR1-oldIndexRR1)>z*appset.numTargets){
            ...
            inputF=appset.outFolderPath+"\\view2tmpF1.out"/*"C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\wbtmpS1.out"*/;
        }
        else if(rightSide1==1 && (endIndexRR-oldIndexRR)>z*appset.numTargets){
            input=appset.outFolderPath+"\\view1tmp1.out"/*"C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\unctadtmpS1.out"*/;
            inputF=appset.outFolderPath+"\\view1tmpF1.out"/*"C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\unctadtmpS1.out"*/;
        }
        //String input1="C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\unctad.out";
       int newRules1=0;
       ...
       nclMatInit.loadGlobalInfo(appset);
        ...
        System.out.println("Validation in main");
         ...
         if(appset.numRetRed==Integer.MAX_VALUE){
                    ...
                    rs.writeToFile(appset.outFolderPath+"\\"+appset.outputName+(1)+".rr", datJ, fid, startTime,numFullRed,appset, nclMatInit ,0, coverage,oom);
                    rs.writePlots(appset.outFolderPath+"\\"+"RuleData"+(1)+".csv", appset,datJ,fid);
      ...
      //rs.writeToFile(appset.outFolderPath+"\\"+appset.outputName, datJ, fid, rr, rr1, startTime,numFullRed,appset);//fix output file name
       System.out.println("num nodes global: "+nclMatInit.globalNodeInfo.keySet().size());
        String output = "";
       String jstr = "";
     if(appset.useJoin == true)
         jstr = "Join";
     output = appset.outFolderPath+"\\"+appset.outputName+""+init+"NoNet"+appset.spatialMeasures.get(0)+"Alpha="+appset.Alpha+jstr+".rr";
      Result.writeToFile(output, datJ, fid, startTime,numFullRed,appset, nclMatInit ,ResultsScore, coverage,oom);
      
      String outputPlots = "";
       outputPlots = appset.outFolderPath+"\\"+"RuleData"+""+init+"NoNet"+appset.spatialMeasures.get(0)+"Alpha="+appset.Alpha+jstr;
       
      
      if( appset.spatialMatrix.size()<=0 )
            Result.writePlots(outputPlots+".csv", appset,datJ,fid);
      else Result.writePlotsNet(outputPlots+".csv", appset,datJ,nclMatInit,fid);
     
     plotOutput+=Result.makePlotsNetString(appset, datJ, nclMatInit, fid);
    ...
    //  coc.computeMatrix(Result, datJ);
     ...
     if(appset.useJoin == true)
         jstr = "Join";
            String outputPlots = "";
       outputPlots = appset.outFolderPath+"\\"+"RuleData"+""+"All"+"NoNet"+appset.spatialMeasures.get(0)+"Alpha="+appset.Alpha+jstr;
       RedescriptionSet tmp = new RedescriptionSet();
       tmp.writeStringToFile(new File(outputPlots+".csv"),  plotOutput); 
     }
 }
}

...
public class TargetsNom {
     ...
     public static void main(String[] args) {
       ...
       /* DataSetCreator dat=new DataSetCreator("C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\Jinput.arff");
        ...
        int countT=0;
         File targ=new File("C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\targetsMetals.txt");
         //File targ=new File("C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\testDataFirstPartClass.txt");
        //File targ=new File("C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\genderFirstDist.txt");
       ...
       while((line=reader.readLine())!=null){
         /*  countT++;
           ...
           String p[] = line.split("\t");
            p[0]=p[0].replace("BF00", "");
            p[0]=p[0].replace("BF0", "");
            p[0]=p[0].replace("BF", "");
           
            targetLabel.put(p[0], p[1].trim());
       }
        }
       catch(Exception e){}
       ...
       // readerReds.inputFile=new File("C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\redescriptionsConstrainedADFirstPAPP-AReduced1.rr");
          readerReds.inputFile=new File("C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\redescriptionsMetalsADStLev_0 minjs 0.1 JSType 0_3000_6000.rr"); 
        ...
        //posTVal.add("Female"); posTVal.add("Male"); 
        ...
        try{
            //File output=new File("C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\redescriptionsConstrainedADFirstPAPP-AReduced1DistG.txt");
            File output=new File("C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\redescriptionsMetalsADStLev_0 minjs 0.1 JSType 0_3000_6000Dist.txt");

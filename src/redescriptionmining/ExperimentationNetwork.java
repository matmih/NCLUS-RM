 ...
 * @author matej
 */
public class ExperimentationNetwork {
...
NHMCDistanceMatrix nclMatInit=null;
      if(appset.distanceFilePaths.size()==0 && appset.useNetworkAsBackground==true || appset.computeDensity == true){
        ...
        int g = 0;
        //petlja za join
        //petlja za alpha, 0.1, 0.3, 0.5, 0.7, 0.9
        //petlja za inicijalizacije
   for(int alp = 0;alp<6;alp++){
     ...
     for(int init = 1;init<=10;init++){
          appset.networkInit=true;
             Mappings fid=new Mappings();
        System.out.println("Bandwidth system: "+appset.Bandwith);
        ...
        if(appset.initClusteringFileName.equals(""))
            ...
            appset.initClusteringFileName = initFileName+init+".arff";
   ...
   */
     ...
     if(appset.useJoin == true)
         jstr = "Join";
     output = appset.outFolderPath+"\\"+appset.outputName+""+init+appset.spatialMeasures.get(0)+"Alpha="+appset.Alpha+jstr+".rr";
       Result.writeToFile(output, datJ, fid, startTime,numFullRed,appset, nclMatInit ,ResultsScore, coverage,oom);
      
       String outputPlots = "";
       outputPlots = appset.outFolderPath+"\\"+"RuleData"+""+init+appset.spatialMeasures.get(0)+"Alpha="+appset.Alpha+jstr;
    ...
    //  coc.computeMatrix(Result, datJ);
     ...
     if(appset.useJoin == true)
         jstr = "Join";
            String outputPlots = "";
       outputPlots = appset.outFolderPath+"\\"+"RuleData"+""+"All"+appset.spatialMeasures.get(0)+"Alpha="+appset.Alpha+jstr;

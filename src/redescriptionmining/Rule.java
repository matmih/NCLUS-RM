...
public class Rule {
   ...
   // int UsedIn=0;
    ...
    void addElement(String element, Mappings map){
        if(!map.exampleId.keySet().contains(element)){
            System.out.println("Map size: "+map.exampleId.keySet().size());
            Iterator<String> it = map.exampleId.keySet().iterator();
            while(it.hasNext())
                System.out.print(it.next()+" ");
            System.out.println();
            System.out.println("Err: "+element);
        }

...
public class NewBasicAlgorithmMain {
    ...
    public static void main(String[] args) {
       ...
       /* int testEnd=1;
        ...
        if(testEnd==1)
            return;*/
        double Statistics[]=new double[3];//previousMedian - 0, numberIterationsStable - 1, minDifference - 2
        ArrayList<Double> maxDiffScoreDistribution=new ArrayList<>(10);
        ...
        if(appset.useSplitTesting==true){
            datJFull=datJ;
            datJ=datJ.createSplit(appset.percentageForTrain);
      ...
      Result.writeToFile(appset.outFolderPath+"\\"+appset.outputName, datJ, fid, startTime,numFullRed,appset, nclMatInit ,ResultsScore, coverage,oom);
